...
const LatestCollections = () => {
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="flex items-center space-x-6 pt-4 border-t border-gray-100">
          <div className="text-center">
            ...
            <div className="text-xs text-gray-500 font-light">Products</div>
          </div>
          <div className="text-center">
            <div className="text-lg font-light text-gray-900">4</div>
            <div className="text-xs text-gray-500 font-light">Categories</div>
          </div>
          <div className="text-center">
            <div className="text-lg font-light text-gray-900">New</div>
            <div className="text-xs text-gray-500 font-light">Season</div>
          </div>
        </div>
      </div>
  ...
  // Category Card - Smaller size (unchanged)
        ...
        <div className="flex items-center justify-between mb-12">
          <div>
            ...
            <p className="text-gray-600 text-sm sm:text-base font-light tracking-wide max-w-2xl">
              Discover our newest collections, products, and categories
            </p>
          </div>
          <Link 
