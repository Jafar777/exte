    ...
    <>
      ...
      <section className="newsletter-section font-black">
        <div className="newsletter-container">
          ...
          <p className="newsletter-description">Subscribe for exclusive updates and early access to new collections</p>
        ...
        <div className="footer-container">
          ...
          <div className="logo-section">
            ...
            <p className="brand-description ">
              Timeless elegance and contemporary style for the modern individual.
            </p>
          </div>
          ...
          <div className="footer-grid font-black">
            ...
            <div className="footer-column">
              ...
              <ul className="footer-links">
                ...
                <li><a href="#" className="footer-link">Seasonal</a></li>
              </ul>
            </div>
            ...
            <div className="footer-column">
              ...
              <ul className="footer-links">
                <li><a href="#" className="footer-link">About Exet</a></li>
          ...
          <div className="footer-bottom">
            <p className="copyright">© {currentYear} EXET. ALL RIGHTS RESERVED.</p>
          </div>
        </div>
      </footer>
