...
const fetchLikedProducts = async () => {
  ...
  const handleUnlike = async (productId) => {
    try {
      ...
      if (response.ok) {
        ...
        alert('Failed to remove from likes');
      }
    } catch (error) {
    ...
    return (
      <div className="min-h-screen bg-gray-50 py-16">
        <div className="max-w-md mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-8">Please sign in to view your liked products.</p>
          <Link
            href="/auth/signin"
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-light tracking-wide text-gray-900 mb-8">Liked Products</h1>
