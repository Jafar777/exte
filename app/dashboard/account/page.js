...
export default function AccountPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      {/* Header - Zara Style */}
      <div className="mb-8">
        <h1 className="text-3xl font-light tracking-wider text-gray-900 uppercase">Account Settings</h1>
          ...
          <form onSubmit={handleProfileUpdate} className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row items-start gap-8 pb-8 border-b border-gray-200">
              ...
              <div className="flex-1 space-y-4 ">
                <h3 className="text-lg font-light tracking-wide text-gray-900">PROFILE PHOTO</h3>
                <CldUploadWidget
